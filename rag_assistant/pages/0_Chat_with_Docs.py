...
#     session_options = [f"{session_id} (Created on {session_id.replace('_', ' ')})" for session_id in [session_id] + chat_sessions]
#     selected_session = st.sidebar.radio("Select Chat Session", session_options)
