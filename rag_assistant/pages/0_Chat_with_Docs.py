...
# def hide_suggested_question(question_idx):
#     st.session_state[f"suggested_question_{question_idx}_hidden"] = True
...
#             suggested_questions_visible = False  # Set flag to indicate suggested questions are visible
#             hide_suggested_question(i)  # Hide the clicked suggested question
#             handle_assistant_response(st.session_state.user_query)  # Handle the response

# # Hide suggested questions if a user query is entered
# if not suggested_questions_visible:
#     for i in range(1, len(suggested_questions) + 1):
#         hide_suggested_question(i)
...
#     # Hide suggested questions if user interacts with the chat
#     for i in range(1, len(suggested_questions) + 1):
#         hide_suggested_question(i)
#     st.chat_message("user").write(user_query)
